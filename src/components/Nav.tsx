...
export default function Navigation(): React.ReactElement {
  ...
  return (
    <>
      <div className="fixed inset-x-0 bottom-0 h-[8rem] lg:h-[4rem] pb-safe bg-white shadow-md flex justify-around items-center z-10  border-t-2">
        ...
        {/* <Drawer
          ...
          closeIcon={false}
          destroyOnClose
          afterOpenChange={() => setWeather(null)}
          extra={
            <Button
              type="text"
              className="h-full p-2"
